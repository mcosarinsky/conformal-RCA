...
from sam2.utils.misc import concat_points, fill_holes_in_mask_scores, load_video_frames, load_video_frames_by_np_data
...
class SAM2VideoPredictor(SAM2Base):
    ...
    def _run_single_frame_inference(
        ...
        if self.fill_holes and self.fill_hole_area > 0:
    ...
    def init_state_by_np_data(
        ...
        """Initialize an inference state."""
        compute_device = self.device  # device of the model
        images, video_height, video_width = load_video_frames_by_np_data(
            np_images=images_np,
            image_size=self.image_size,
            offload_video_to_cpu=offload_video_to_cpu,
            compute_device=compute_device,
